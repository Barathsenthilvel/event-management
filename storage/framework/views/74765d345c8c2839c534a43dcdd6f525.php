    ...
    <div class="bg-white rounded-[24px] border border-slate-100 shadow-sm overflow-hidden">
        <div class="p-6 border-b border-slate-50 flex items-center justify-between">
            <div>
                ...
                <p class="text-[11px] font-bold text-slate-500 mt-1">Total: <?php echo e($members->total()); ?></p>
            </div>
        </div>
                        ...
                        <?php $__currentLoopData = $members; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $m): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="px-6 py-4 text-center">
                                    <a href="<?php echo e(route('admin.members.pending-approvals.show', $m)); ?>"
                                       ...
                                       aria-label="View full profile for <?php echo e($m->name); ?>">
                                ...
                                <td class="px-6 py-4 text-right">
                                    <div class="flex items-center justify-end gap-2">
                                        <form method="POST" action="<?php echo e(route('admin.members.pending-approvals.approve', $m->id)); ?>" onsubmit="return confirm('Approve this member? They will be able to sign in and purchase membership plans.');">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views/admin/members/pending-approvals.blade.php ENDPATH**/ ?>