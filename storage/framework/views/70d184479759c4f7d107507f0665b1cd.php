...
<div class="flex-1 min-h-0 overflow-y-auto custom-scroll flex flex-col p-6 gap-4">
    <!-- Page Header -->
    <div>
    ...
    <div class="flex-1 overflow-y-auto custom-scroll">
        <table class="min-w-full text-left text-xs">
                ...
                <tr>
                    <td class="px-6 py-4 align-middle">
                        <div class="flex items-center gap-3">
                            <div
                                class="w-10 h-10 rounded-xl border border-slate-200 flex items-center justify-center text-slate-400 shrink-0">
                            ...
                            <div class="min-w-0">
                                <p class="font-semibold text-slate-900"><?php echo e($ebook->title); ?></p>
                                <p class="text-[11px] text-slate-400"><?php echo e($ebook->code); ?></p>
                            </div>
                        </div>
                    </td>
                    <td class="px-6 py-4 text-center align-middle">
                        <form method="POST" action="<?php echo e(route('admin.ebooks.toggle-promote', $ebook->id)); ?>" class="inline-flex">
                            <?php echo csrf_field(); ?>
                            <button class="inline-flex items-center cursor-pointer">
                                <span class="w-10 h-5 <?php echo e($ebook->promote_front ? 'bg-emerald-400/60' : 'bg-slate-300/70'); ?> rounded-full relative shadow-inner">
                                <span class="absolute top-0.5 left-0.5 w-4 h-4 bg-white rounded-full shadow transition-transform
                                    <?php echo e($ebook->promote_front ? 'translate-x-5' : ''); ?>"></span>
                                </span>
                            </button>
                        </form>
                    </td>
                    <td class="px-6 py-4 align-middle">
                        <p class="text-[11px] text-slate-500"><?php echo e($ebook->created_at->format('d M Y')); ?></p>
                        <p class="font-semibold text-[11px] text-slate-700"><?php echo e($ebook->creator->name ?? 'Admin'); ?></p>
                    </td>
                    <td class="px-6 py-4 align-middle">
                        <p class="text-[11px] text-slate-500"><?php echo e($ebook->updated_at->format('d M Y')); ?></p>
                        <p class="font-semibold text-[11px] text-slate-700"><?php echo e($ebook->creator->name ?? 'Admin'); ?></p>
                    </td>
                    <td class="px-6 py-4 text-center align-middle">
                    ...
                    <td class="px-6 py-4 text-right align-middle">
                        <div class="inline-flex items-center justify-end gap-2">
                            ...
                            <form method="POST" action="<?php echo e(route('admin.ebooks.toggle-status', $ebook->id)); ?>" class="inline-flex">
                                <?php echo csrf_field(); ?>
                            ...
                            <form id="admin-delete-ebook-<?php echo e($ebook->id); ?>" method="POST" action="<?php echo e(route('admin.ebooks.destroy', $ebook->id)); ?>" class="inline-flex">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
                                <button type="button" title="Delete"
                                    data-delete-form="admin-delete-ebook-<?php echo e($ebook->id); ?>"
                                    data-delete-title="Delete this e-book?"
                                    data-delete-message="This will remove the e-book file and listing permanently."
            ...
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <tr>
                    <td colspan="6" class="px-6 py-10 text-center text-slate-500 font-semibold">No e-books found.</td>
                </tr>
            <?php endif; ?>
            </tbody>
        </table>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\admin\ebooks\index.blade.php ENDPATH**/ ?>