...
<div id="event-interest-modal" class="fixed inset-0 z-[200] hidden items-center justify-center p-4" aria-hidden="true">
    ...
    <div class="relative w-full max-w-md rounded-2xl border border-[#351c42]/10 bg-white p-6 shadow-2xl shadow-[#351c42]/20 max-h-[90vh] overflow-y-auto">
        ...
        <div id="interest-step-member" class="hidden mt-5 space-y-4">
            ...
            <a href="<?php echo e($memberLoginReturn); ?>" class="flex w-full items-center justify-center rounded-2xl bg-[#351c42] px-5 py-3 text-sm font-extrabold text-[#fddc6a] shadow-md hover:bg-[#4d2a5c]">
                Member login
            </a>
            <p class="text-center text-xs text-[#351c42]/55">New member?</p>
            <a href="<?php echo e($memberRegisterReturn); ?>" class="flex w-full items-center justify-center rounded-2xl border border-[#351c42]/20 bg-white px-5 py-3 text-sm font-extrabold text-[#351c42] hover:bg-[#351c42]/5">
                Create an account
            </a>
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views/home/partials/event-interest-modal.blade.php ENDPATH**/ ?>