...
<div class="flex-1 overflow-y-auto custom-scroll p-6">
    <div class="max-w-6xl mx-auto space-y-5">
        ...
        <form method="POST" action="<?php echo e(route('admin.nominations.alert.store', $nomination->id)); ?>" class="bg-white border border-slate-100 rounded-2xl p-5 shadow-sm space-y-5">
            <?php echo csrf_field(); ?>
                ...
                <div class="space-y-5">
                    <div>
                        ...
                        <div class="space-y-2 text-sm font-bold text-slate-700">
                            <label class="inline-flex items-center gap-2 mr-3"><input type="radio" name="target" value="all" <?php echo e($target === 'all' ? 'checked' : ''); ?>> All Members</label>
                            <label class="inline-flex items-center gap-2 mr-3"><input type="radio" name="target" value="specific" <?php echo e($target === 'specific' ? 'checked' : ''); ?>> Specific</label>
                            <label class="inline-flex items-center gap-2"><input type="radio" name="target" value="leaders" <?php echo e($target === 'leaders' ? 'checked' : ''); ?>> Leaders Only</label>
                        </div>
                    </div>
                    <div>
