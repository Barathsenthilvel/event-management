...
<body class="ml-page-bg text-[#351c42] antialiased" data-auth-default="<?php echo e($defaultTab ?? 'signin'); ?>">
    <header class="sticky top-0 z-40 ml-glass-header">
        <div class="mx-auto flex max-w-7xl items-center gap-3 px-4 py-3.5 lg:gap-6">
            ...
            <a href="<?php echo e(route('home')); ?>" class="flex min-w-0 max-w-[min(48vw,200px)] shrink-0 items-center sm:max-w-[220px]" aria-label="GNAT Association home">
                <img src="<?php echo e(asset('images/logo.png')); ?>" alt="GNAT Association" class="h-8 w-auto max-h-11 max-w-full object-contain object-left sm:h-11" width="200" height="48" />
            </a>
            <nav class="hidden flex-1 items-center justify-center gap-6 lg:flex xl:gap-10" aria-label="Primary">
                <a href="<?php echo e(route('home')); ?>#home" class="ml-nav-link">Home</a>
                <a href="<?php echo e(route('home')); ?>#about2" class="ml-nav-link">About us</a>
                <a href="<?php echo e(route('home')); ?>#events" class="ml-nav-link">Events</a>
                <a href="<?php echo e(route('home')); ?>#gallery" class="ml-nav-link">Gallery</a>
                <a href="<?php echo e(route('home')); ?>#contact" class="ml-nav-link">Contact us</a>
            </nav>
            <div class="ml-auto flex shrink-0 items-center gap-2 sm:gap-3">
                <a href="<?php echo e(route('member.login')); ?>" class="inline-flex h-10 w-10 items-center justify-center rounded-full bg-white text-[#351c42] shadow-md shadow-[#351c42]/8 ring-1 ring-[#351c42]/10 transition hover:bg-[#351c42] hover:text-white hover:ring-[#351c42] sm:h-11 sm:w-11" aria-label="Member login">
                ...
                <a href="<?php echo e(route('donations.index')); ?>" class="hidden rounded-full bg-gradient-to-r from-[#fddc6a] to-[#f5d56a] px-5 py-2.5 text-xs font-bold text-[#311742] shadow-lg shadow-amber-200/50 ring-1 ring-amber-200/60 transition hover:brightness-105 min-[400px]:inline-flex sm:text-sm">Donate</a>
            </div>
        </div>
        <div id="ml-mobile-nav" class="ml-mobile-panel border-t border-[#351c42]/10 bg-white/95 backdrop-blur-md lg:hidden" hidden>
            <nav class="flex flex-col px-4 py-4 pb-6" aria-label="Mobile">
                <a href="<?php echo e(route('home')); ?>#home" class="rounded-xl px-3 py-3 text-sm font-bold uppercase tracking-wide text-[#351c42] hover:bg-[#351c42]/5">Home</a>
                <a href="<?php echo e(route('home')); ?>#about2" class="rounded-xl px-3 py-3 text-sm font-bold uppercase tracking-wide text-[#351c42] hover:bg-[#351c42]/5">About us</a>
                <a href="<?php echo e(route('home')); ?>#events" class="rounded-xl px-3 py-3 text-sm font-bold uppercase tracking-wide text-[#351c42] hover:bg-[#351c42]/5">Events</a>
                <a href="<?php echo e(route('home')); ?>#gallery" class="rounded-xl px-3 py-3 text-sm font-bold uppercase tracking-wide text-[#351c42] hover:bg-[#351c42]/5">Gallery</a>
                <a href="<?php echo e(route('home')); ?>#contact" class="rounded-xl px-3 py-3 text-sm font-bold uppercase tracking-wide text-[#351c42] hover:bg-[#351c42]/5">Contact us</a>
                <a href="<?php echo e(route('donations.index')); ?>" class="mt-4 rounded-full bg-[#351c42] py-3.5 text-center text-sm font-bold text-[#fddc6a] shadow-lg">Donate</a>
            </nav>
        </div>
    </header>
