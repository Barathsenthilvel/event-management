...
<div
    ...
    x-data="{ thanksOpen: <?php echo e($thanksForThisPoll ? 'true' : 'false'); ?> }"
    aria-label="Live polling"
>
    <?php if($successForThisPoll): ?>
    ...
    <article class="relative rounded-2xl border border-[#351c42]/10 bg-[#f6f3e9] p-4 sm:p-5">
        ...
        <h2 class="pr-10 text-xl font-extrabold uppercase tracking-wide text-[#351c42] sm:text-2xl"><?php echo e($poll->title); ?></h2>
        <p class="mt-2">
            <span
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\member\partials\dashboard-live-polling.blade.php ENDPATH**/ ?>