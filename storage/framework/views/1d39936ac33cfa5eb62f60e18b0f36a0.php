        ...
        <div x-show="open" class="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/50 p-4 backdrop-blur-sm">
            <div class="max-h-[90vh] w-full max-w-lg overflow-y-auto rounded-2xl border border-[#351c42]/10 bg-white p-8 shadow-2xl">
                ...
                <div class="mt-6 flex flex-wrap justify-end gap-3">
                    <a href="<?php echo e(route('member.profile.edit')); ?>" class="rounded-full border border-[#351c42]/15 px-5 py-2.5 text-sm font-bold text-[#351c42] hover:bg-[#351c42]/5">Review profile</a>
...
<?php endif; ?>
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views/member/partials/member-portal-gate-modals.blade.php ENDPATH**/ ?>