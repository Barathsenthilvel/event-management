    ...
    <div class="max-w-3xl mx-auto bg-white p-8 md:p-12 rounded-[28px] shadow-sm border border-slate-100 relative">
        ...
        <div class="flex justify-between items-start mb-10">
            <div>
                ...
                <p class="text-sm font-extrabold text-slate-900 mt-1"><?php echo e($user->name ?? $user->first_name . ' ' . $user->last_name); ?></p>
                <p class="text-sm text-slate-500"><?php echo e($user->email); ?></p>
                <p class="text-sm text-slate-500"><?php echo e($user->mobile); ?></p>
            </div>
            <div class="text-right">
                ...
                <table class="mt-1 text-sm text-right ml-auto">
                    <tr>
                        ...
                        <td class="font-extrabold text-slate-900"><?php echo e($transaction->created_at->format('M d, Y')); ?></td>
                    </tr>
                    <tr>
                        <td class="pr-4 font-bold text-slate-500">Transaction ID:</td>
                        <td class="font-extrabold text-slate-900">#<?php echo e(str_pad($transaction->id, 5, '0', STR_PAD_LEFT)); ?></td>
                    </tr>
                    <tr>
                        <td class="pr-4 font-bold text-slate-500">Payment ID:</td>
                        <td class="font-bold text-slate-700 font-mono text-xs"><?php echo e($transaction->razorpay_payment_id ?? 'N/A'); ?></td>
                    </tr>
                </table>
            </div>
        </div>
                ...
                <tbody class="text-sm">
                    <tr>
                        <td class="py-5 px-5 border-b border-slate-100 hidden md:table-cell">
                            <p class="font-extrabold text-slate-900">Membership <?php echo e($plan->subscription_type === 'New' ? 'Registration' : 'Renewal'); ?></p>
                            <p class="text-slate-500 text-xs mt-1">Plan: <?php echo e($plan->subscription_type); ?> | Cycle: <?php echo e(ucfirst(str_replace('_', ' ', $plan->payment_type))); ?></p>
                        </td>
        ...
        <div class="flex justify-end mb-12">
            <div class="w-full max-w-sm rounded-[20px] bg-slate-50 p-6">
                <div class="flex justify-between items-center mb-2">
                    ...
                    <span class="text-sm font-extrabold text-slate-900">₹ <?php echo e(number_format($transaction->amount, 2)); ?></span>
                </div>
                ...
                <div class="flex justify-between items-center">
                    ...
                    <span class="text-xl font-extrabold text-emerald-600">₹ <?php echo e(number_format($transaction->amount, 2)); ?></span>
                </div>
            </div>
        </div>
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\member\subscription\invoice.blade.php ENDPATH**/ ?>