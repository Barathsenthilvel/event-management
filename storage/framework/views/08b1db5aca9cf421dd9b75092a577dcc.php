            ...
            <div>
                <div class="flex items-center gap-3 mb-12">
                    <div class="w-10 h-10 bg-[#351c42] rounded-2xl flex items-center justify-center">
                        <img src="<?php echo e(asset('images/logo.png')); ?>" alt="GNAT" class="h-7 w-auto object-contain">
                    </div>
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\admin\auth\login.blade.php ENDPATH**/ ?>