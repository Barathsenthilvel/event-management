        ...
        <div class="grid gap-10 lg:grid-cols-[300px_1fr] items-start">
            <div class="lg:sticky lg:top-8">
                <div class="inline-flex items-center gap-2 text-sm font-semibold tracking-wide text-[#965995]">
                    ...
                    <?php echo e($blog['section_badge'] ?? 'Our blog'); ?>

                </div>

                <h2 class="mt-3 text-3xl md:text-4xl font-extrabold leading-tight text-[#351c42]">
                    <?php echo e($blog['section_title'] ?? 'Insights & Updates'); ?>

                </h2>

                <p class="mt-6 text-[#351c42]/65 text-base leading-7 max-w-sm">
                    <?php echo e($blog['section_description'] ?? 'Stay informed with the latest news, stories, and updates from GNAT Association. Explore ideas and initiatives shaping our communities.'); ?>

                </p>

                <a href="<?php echo e(route('blogs.index')); ?>" class="click-btn btn-style506 mt-8 inline-flex">
                    ...
                    <span class="click-btn__label"><?php echo e($blog['section_button_text'] ?? 'Explore All Posts'); ?></span>
                </a>
            </div>
            ...
            <div>
                <div class="overflow-hidden" data-blog-viewport>
                    <div class="flex flex-nowrap gap-4 will-change-transform transition-transform duration-500 ease-out" data-blog-track>
                        <?php $__currentLoopData = $blog['posts']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <article class="shrink-0 min-w-[320px] max-w-[320px] rounded-2xl bg-white border border-[#351c42]/10 overflow-hidden shadow-sm">
                                <div class="relative h-56">
                                    <img src="<?php echo e(asset($post['image'])); ?>" alt="Blog post image" class="h-full w-full object-cover"/>
                                    <span class="absolute left-4 top-4 rounded-full bg-white/75 backdrop-blur px-3 py-1 text-xs font-semibold text-[#351c42]"><?php echo e($post['tag']); ?></span>
                                    <div class="absolute right-0 bottom-0 rounded-tl-2xl bg-[#351c42] text-[#fddc6a] text-center px-4 py-2">
                                        <div class="text-4xl font-extrabold leading-none"><?php echo e($post['day']); ?></div>
                                        <div class="text-lg font-semibold leading-none mt-1 text-white"><?php echo e($post['month']); ?></div>
                                        <div class="mt-1 text-[10px] tracking-[0.35em] font-bold bg-[#fddc6a] text-[#351c42] rounded px-2 py-0.5"><?php echo e($post['year']); ?></div>
                                    </div>
                                </div>
                                <div class="p-5">
                                    <h3 class="text-3xl font-extrabold text-[#351c42]"><?php echo e($post['title']); ?></h3>
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views/home/sections/blog.blade.php ENDPATH**/ ?>