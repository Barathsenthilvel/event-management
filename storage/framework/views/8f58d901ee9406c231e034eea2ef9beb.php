...
<div class="max-w-3xl mx-auto">
    ...
    <form method="POST" action="<?php echo e(route('admin.admins.store')); ?>" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="tel" name="phone"
                    class="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-indigo-500/5"
                    placeholder="+1234567890" value="<?php echo e(old('phone')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-2">Password <?php echo $__env->make('admin.partials.required-mark', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></label>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                <label class="block text-sm font-bold text-slate-700 mb-2">Confirm Password <?php echo $__env->make('admin.partials.required-mark', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?></label>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\admin\admins\create.blade.php ENDPATH**/ ?>