...
>
    <p class="mb-3 text-[0.65rem] font-bold uppercase tracking-widest text-[#965995]"><?php echo e($showFullMemberMenu ? 'Menu' : ($canSeeMembership ? 'Membership' : 'Account')); ?></p>
    <nav class="flex flex-col gap-1" aria-label="Member">
        <?php if($showFullMemberMenu): ?>
            ...
            <a href="<?php echo e(route('member.subscription.index')); ?>" class="md-sidebar-link" data-md-nav><span class="h-1.5 w-1.5 rounded-full bg-[#351c42]/25"></span> Membership</a>
            ...
            <a href="<?php echo e(route('member.jobs.index')); ?>" class="md-sidebar-link <?php echo e(request()->routeIs('member.jobs.*') ? 'is-active' : ''); ?>" data-md-nav><span class="h-1.5 w-1.5 rounded-full <?php echo e(request()->routeIs('member.jobs.*') ? 'bg-[#965995]' : 'bg-[#351c42]/25'); ?>"></span> Search jobs</a>
            <a href="<?php echo e(route('member.profile.edit')); ?>" class="md-sidebar-link"><span class="h-1.5 w-1.5 rounded-full bg-[#351c42]/25"></span> Profile</a>
            <a href="<?php echo e(route('member.password.edit')); ?>" class="md-sidebar-link"><span class="h-1.5 w-1.5 rounded-full bg-[#351c42]/25"></span> Change password</a>
        <?php elseif($canSeeMembership): ?>
        ...
        <?php else: ?>
            <a href="<?php echo e(route('member.profile.edit')); ?>" class="md-sidebar-link is-active" data-md-nav><span class="h-1.5 w-1.5 rounded-full bg-[#965995]"></span> Profile</a>
            <a href="<?php echo e(route('member.password.edit')); ?>" class="md-sidebar-link" data-md-nav><span class="h-1.5 w-1.5 rounded-full bg-[#351c42]/25"></span> Change password</a>
        <?php endif; ?>
    </nav>
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\member\partials\member-portal-sidebar.blade.php ENDPATH**/ ?>