                ...
                >
                    <?php $__currentLoopData = $banners; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $banner): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        >
                            ...
                            <?php if(!empty($banner['eyebrow']) || !empty($banner['title']) || !empty($banner['text'])): ?>
                                <div class="pointer-events-none absolute inset-x-0 bottom-0 z-[1] px-4 pb-16 pt-8 sm:px-6 sm:pb-20">
                                    <div class="max-w-2xl">
                                        <?php if(!empty($banner['eyebrow'])): ?>
                                            <p class="text-[10px] font-black uppercase tracking-[0.18em] text-[#fddc6a] sm:text-xs"><?php echo e($banner['eyebrow']); ?></p>
                                        <?php endif; ?>
