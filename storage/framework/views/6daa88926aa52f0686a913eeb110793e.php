<?php $__env->startSection('title', 'Forgot password — GNAT Association'); ?>
    ...
    <div id="auth-main">
        ...
        <div class="mx-auto max-w-xl overflow-hidden rounded-3xl border border-white/60 bg-white/70 p-2 shadow-2xl shadow-[#351c42]/10 backdrop-blur-sm ml-card-elevated">
            <div class="px-5 pb-8 pt-6 sm:px-8 sm:pb-10 sm:pt-8">
                <form class="space-y-5" method="POST" action="<?php echo e(route('member.password.email')); ?>">
                    <?php echo csrf_field(); ?>
                    <div>
                        <label class="ml-label" for="fp-email">Email address</label>
                        <input id="fp-email" name="email" type="email" autocomplete="email" required class="ml-inp" placeholder="name@email.com" value="<?php echo e(old('email')); ?>" />
                    </div>
...
<?php echo $__env->make('member.layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\member\auth\forgot-password.blade.php ENDPATH**/ ?>