...
<body class="bg-[#f8f6fa] text-[#351c42]">
    ...
    <main class="mx-auto max-w-7xl px-4 py-8 space-y-7">
        <section class="rounded-3xl border border-[#351c42]/10 bg-white/85 backdrop-blur p-5 md:p-6 shadow-sm">
            ...
            <form method="get" action="<?php echo e(route('donations.index')); ?>" class="mt-5 flex flex-col gap-3 sm:flex-row sm:items-center">
                <input type="search" name="q" value="<?php echo e($q); ?>" placeholder="Search purpose or description…"
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\home\donations.blade.php ENDPATH**/ ?>