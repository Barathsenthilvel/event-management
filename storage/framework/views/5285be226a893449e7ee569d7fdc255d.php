<header class="sticky top-0 z-40">
    <div class="site-header-main">
        <div class="mx-auto max-w-7xl px-4 py-3 lg:py-3.5 flex items-center gap-3 lg:gap-6">
            ...
            <a href="<?php echo e(url('/')); ?>#home" class="flex items-center shrink-0 min-w-0 max-w-[min(52vw,200px)] sm:max-w-[220px]" aria-label="GNAT Association home">
                <img
                    src="<?php echo e(asset($logo['src'])); ?>"
                    alt="<?php echo e($logo['alt']); ?>"
            ...
            <nav class="hidden lg:flex flex-1 justify-center items-center gap-2 xl:gap-3 text-sm font-semibold text-[#3d4d5c]" aria-label="Primary">
                <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <a href="<?php echo e(url('/')); ?><?php echo e($link['href']); ?>" class="site-nav-link"><?php echo e($link['label']); ?></a>
            ...
            <div class="flex items-center gap-2 sm:gap-3 ml-auto shrink-0">
                <?php if(auth()->guard()->guest()): ?>
                    <a
                        href="<?php echo e(route('member.login')); ?>"
                ...
                <?php else: ?>
                    <a
                        href="<?php echo e(route('member.dashboard')); ?>"
...
<aside
    ...
    role="dialog"
    aria-modal="true"
    aria-label="GNAT Association menu"
    aria-hidden="true"
>
    <div class="flex items-center justify-between gap-4 p-5 border-b border-white/10 shrink-0">
        <a href="<?php echo e(url('/')); ?>#home" class="flex items-center gap-2 min-w-0 rounded-lg bg-white/95 px-2.5 py-1.5 shadow-sm" aria-label="GNAT Association home">
            <img
                src="<?php echo e(asset($logo['src'])); ?>"
                alt="<?php echo e($logo['alt']); ?>"
    ...
    <div class="flex-1 overflow-y-auto overscroll-contain p-5 pb-8">
        <p class="text-white/75 text-sm leading-relaxed">
            <strong class="text-white">GNAT Association</strong> connects generous supporters with trusted programs in education, health, and community support—so every contribution creates lasting impact.
        </p>
        ...
        <ul class="mt-4 space-y-4 text-white/90 text-sm">
            ...
            <li class="flex gap-3">
                ...
                <a href="mailto:<?php echo e($contact['email']); ?>" class="hover:text-[#fddc6a] transition-colors"><?php echo e($contact['email']); ?></a>
            </li>
            <li class="flex gap-3">
                <span class="shrink-0 mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full bg-white/10 text-[#fddc6a]">
                    <svg class="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
        ...
        <nav class="mt-10 flex flex-col gap-1 border-t border-white/10 pt-8" aria-label="Mobile">
            <?php $__currentLoopData = $nav; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <a href="<?php echo e(url('/')); ?><?php echo e($link['href']); ?>" class="py-2.5 text-white font-bold border-b border-white/5 hover:text-[#fddc6a]"><?php echo e($link['label']); ?></a>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if(auth()->guard()->check()): ?>
                <div class="mt-4 border-t border-white/10 pt-4">
                    <p class="text-[10px] font-extrabold uppercase tracking-[0.2em] text-[#fddc6a]/90">Member portal</p>
                    <a href="<?php echo e(route('member.dashboard')); ?>" class="mt-3 block py-2.5 text-white font-bold border-b border-white/5 hover:text-[#fddc6a]">Dashboard</a>
                    <a href="<?php echo e(route('member.events.index')); ?>" class="block py-2.5 text-white font-bold border-b border-white/5 hover:text-[#fddc6a]">Events</a>
                    <a href="<?php echo e(route('member.ebooks.index')); ?>" class="block py-2.5 text-white font-bold border-b border-white/5 hover:text-[#fddc6a]">E-Books</a>
                    <a href="<?php echo e(route('member.subscription.index')); ?>" class="block py-2.5 text-white font-bold border-b border-white/5 hover:text-[#fddc6a]">Membership</a>
                    <a href="<?php echo e(route('member.profile.edit')); ?>" class="block py-2.5 text-white font-bold border-b border-white/5 hover:text-[#fddc6a]">Profile</a>
                </div>
            <?php endif; ?>
            <a href="<?php echo e(route('donations.index')); ?>" class="py-2.5 text-white font-bold border-b border-white/5 hover:text-[#fddc6a]">Donate</a>
            <?php if(auth()->guard()->guest()): ?>
                <a href="<?php echo e(route('member.login')); ?>" class="mt-4 inline-flex items-center gap-3 text-white font-bold hover:text-[#fddc6a] transition-colors">
            ...
            <?php else: ?>
                <a href="<?php echo e(route('member.dashboard')); ?>" class="mt-4 inline-flex items-center gap-3 text-white font-bold hover:text-[#fddc6a] transition-colors">
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\home\partials\header.blade.php ENDPATH**/ ?>