        ...
        <div class="bg-white rounded-2xl border border-slate-100 p-6 space-y-6">
            <div>
                ...
                <input type="text" name="name" required
                    ...
                    placeholder="e.g. Content Auditor" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    class="w-full bg-slate-50 border border-slate-100 rounded-xl px-4 py-3 text-sm outline-none focus:ring-4 focus:ring-indigo-500/5"
                    placeholder="Role description..."><?php echo e(old('description')); ?></textarea>
            </div>
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\admin\roles\create.blade.php ENDPATH**/ ?>