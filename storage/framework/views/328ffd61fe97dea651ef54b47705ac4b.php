<footer id="contact" class="relative bg-[#351c42] text-white overflow-hidden">
    <div class="mx-auto max-w-7xl px-4 pt-16 pb-12 grid gap-12 lg:grid-cols-4 lg:gap-10">
        <div>
            ...
            <a
                href="https://www.google.com/maps/search/?api=1&query=<?php echo e($contact['maps_query']); ?>"
                target="_blank"
        ...
        <div>
            ...
            <ul class="space-y-4 text-sm text-white/85">
                ...
                <li class="flex gap-3">
                    ...
                    <a href="mailto:<?php echo e($contact['email']); ?>" class="hover:text-[#fddc6a] transition-colors break-all"><?php echo e($contact['email']); ?></a>
                </li>
            </ul>
        </div>
        ...
        <div>
            ...
            <ul class="space-y-2.5 text-sm font-medium">
                <li><a href="<?php echo e(url('/')); ?>#about2" class="text-white/80 hover:text-[#fddc6a] transition-colors">About Us</a></li>
                ...
                <li><a href="<?php echo e(url('/')); ?>#association-activity" class="text-white/80 hover:text-[#fddc6a] transition-colors">Activity</a></li>
                <li><a href="<?php echo e(url('/')); ?>#events" class="text-white/80 hover:text-[#fddc6a] transition-colors">Our Campaign</a></li>
                <li><a href="<?php echo e(url('/')); ?>#gallery" class="text-white/80 hover:text-[#fddc6a] transition-colors">Gallery</a></li>
                <li><a href="<?php echo e(url('/')); ?>#contact" class="text-white/80 hover:text-[#fddc6a] transition-colors">Contact Us</a></li>
            </ul>
        </div>
    ...
    <div class="relative border-t border-black/10 bg-gradient-to-b from-[#f0d78c] via-[#fddc6a] to-[#e8c45c]">
        <div class="mx-auto max-w-7xl px-4 py-5 flex flex-col md:flex-row items-center justify-between gap-5 text-[#351c42]">
            <a href="<?php echo e(url('/')); ?>#home" class="shrink-0">
                <img src="<?php echo e(asset($logo['src'])); ?>" alt="<?php echo e($logo['alt']); ?>" class="h-10 sm:h-11 w-auto max-w-[200px] object-contain object-left" width="200" height="48" loading="lazy" />
            </a>
            <p class="text-sm font-semibold text-center order-last md:order-none">
                © Copyright <span id="footer-year"><?php echo e(date('Y')); ?></span> GNAT Association. All Rights Reserved.
            </p>
...
<?php /**PATH C:\Users\acer\OneDrive\Desktop\projects\event-management\resources\views\home\partials\footer.blade.php ENDPATH**/ ?>