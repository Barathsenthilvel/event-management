    ...
    <div class="mx-auto flex max-w-7xl flex-col gap-6 px-4 py-8 lg:flex-row lg:gap-8 lg:py-10">
        ...
        <main class="min-w-0 flex-1 space-y-10 lg:space-y-12" id="member-dashboard-main">
            ...
            <section aria-labelledby="plans-heading">
                ...
                @if(!$canSeeMembership)
                    <div class="rounded-2xl border border-[#351c42]/10 bg-[#faf9fc] p-6 text-sm leading-relaxed text-[#351c42]/70">
                        <p>We do not show subscription or renewal options until your profile is finished and approved. You can still update your profile from the sidebar.</p>
                    </div>
                @elseif($hasActiveSubscription)
                    <div class="rounded-2xl border border-[#351c42]/10 bg-white/90 p-6 shadow-sm">
                        <h3 class="mb-2 text-sm font-bold uppercase tracking-widest text-[#965995]">Renewal options</h3>
                        <p class="mb-4 text-sm text-[#351c42]/60">Renewal amounts (monthly, quarterly, yearly) are defined in admin. The membership page shows renewal plans only.</p>
                        <a href="{{ route('member.subscription.index') }}" class="md-btn-pay">View renewal plans</a>
                    </div>
                @else
                    <div class="rounded-2xl border border-[#351c42]/10 bg-white/90 p-6 shadow-sm">
                        <p class="mb-4 text-sm text-[#351c42]/65">You are approved. Select your first membership plan; registration fees apply when the office enables them.</p>
                        <a href="{{ route('member.subscription.index') }}" class="md-btn-pay">View subscription plans</a>
                    </div>
                @endif
            </section>
