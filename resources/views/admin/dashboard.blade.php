...
<div class="dashboard-enterprise custom-scroll flex-1 overflow-y-auto p-4 md:p-6 lg:p-8 text-slate-800 antialiased space-y-6">
    ...
    <div class="dash-card rounded-2xl p-4 border-rose-100 bg-gradient-to-r from-rose-50/80 via-white to-white flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1 w-full">
            <div class="bg-slate-50 p-3 rounded-xl border border-slate-100 flex justify-between items-center transition hover:border-emerald-200 hover:bg-emerald-50/30">
                <div class="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <span class="text-xs font-semibold text-slate-800">2026 National Executive Council Call</span>
                    </div>
                </div>
                <span class="bg-emerald-50 text-emerald-700 border border-emerald-200 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider">
                    Live
                </span>
            </div>

            <div class="bg-slate-50 p-3 rounded-xl border border-slate-100 flex justify-between items-center transition hover:border-slate-200">
                <div class="flex items-center gap-3">
                    <div class="relative flex h-2 w-2">
                    ...
                    <div>
                        ...
                        <span class="text-xs font-semibold text-slate-700">Welfare Fund Contribution Amendment</span>
                    </div>
                </div>
                <span class="bg-slate-100 text-slate-600 border border-slate-200 px-2.5 py-0.5 rounded-full text-[10px] font-bold uppercase tracking-wider">
                    Ended
                </span>
            </div>
        </div>
        ...
        <div class="dash-card rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div class="flex justify-between items-start relative">
                <div>
                    ...
                    <h3 class="text-3xl font-bold tracking-tight mt-2 text-slate-900">142,840</h3>
                </div>
        ...
        <div class="dash-card rounded-2xl p-6 flex flex-col justify-between relative overflow-hidden group">
            ...
            <div class="flex justify-between items-start relative">
                <div>
                    ...
                    <h3 class="text-3xl font-bold tracking-tight mt-2 text-amber-600">384</h3>
                </div>
        ...
        <div class="dash-card rounded-2xl p-6 md:col-span-2 lg:col-span-1 flex flex-col justify-between group">
            <div class="flex justify-between items-start">
                <div>
                    ...
                    <h4 class="text-sm font-semibold text-slate-900 mt-2 group-hover:text-indigo-600 transition">Regional Secretariat Executives Summit</h4>
                </div>
            ...
            <div class="mt-4 pt-3 border-t border-slate-100 flex items-center justify-between text-xs text-slate-500">
                ...
                <span class="bg-slate-100 border border-slate-200 px-2 py-0.5 rounded text-slate-700 font-medium">HQ Hall A</span>
            </div>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 xl:grid-cols-3 gap-6">
                    ...
                    <tbody class="divide-y divide-slate-100">
                        <tr class="hover:bg-slate-50 transition-colors group">
                            <td class="py-3.5 px-3">
                                <div class="flex items-center gap-3">
                                    <div class="h-8 w-8 rounded-full bg-indigo-50 text-indigo-600 flex items-center justify-center font-bold text-[11px] border border-indigo-100">FO</div>
                                    <div>
                                        <p class="font-semibold text-slate-800 group-hover:text-indigo-600 transition">Francis Osei-Tutu</p>
                                        <p class="text-[10px] text-slate-500">Primary Division • Kumasi</p>
                                    </div>
                                </div>
                            </td>
                            <td class="py-3.5 px-3 font-mono text-slate-600">GNT-7740-2021</td>
                            <td class="py-3.5 px-3">
                                <span class="text-amber-700 font-medium bg-amber-50 border border-amber-200 px-2 py-0.5 rounded-md">In 4 Days</span>
                            </td>
                            <td class="py-3.5 px-3 text-right">
                                <button type="button" onclick="triggerNotification(this)" class="cursor-pointer inline-flex items-center gap-1 bg-indigo-600 hover:bg-indigo-700 text-white font-medium px-3 py-1.5 rounded-lg text-[11px] shadow-sm active:scale-95 transition-all">
                        ...
                        <tr class="hover:bg-slate-50 transition-colors group">
                            <td class="py-3.5 px-3">
                                <div class="flex items-center gap-3">
                                    <div class="h-8 w-8 rounded-full bg-emerald-50 text-emerald-600 flex items-center justify-center font-bold text-[11px] border border-emerald-100">HA</div>
                                    <div>
                                        <p class="font-semibold text-slate-800 group-hover:text-emerald-600 transition">Harriet Mensah-Annan</p>
                                        <p class="text-[10px] text-slate-500">JHS Technical • Tamale</p>
                                    </div>
                                </div>
                            </td>
                            <td class="py-3.5 px-3 font-mono text-slate-600">GNT-0921-2018</td>
                            <td class="py-3.5 px-3">
                                <span class="text-amber-700 font-medium bg-amber-50 border border-amber-200 px-2 py-0.5 rounded-md">In 9 Days</span>
                            </td>
                            <td class="py-3.5 px-3 text-right">
                                <button type="button" onclick="triggerNotification(this)" class="cursor-pointer inline-flex items-center gap-1 bg-indigo-600 hover:bg-indigo-700 text-white font-medium px-3 py-1.5 rounded-lg text-[11px] shadow-sm active:scale-95 transition-all">
                                    <i class="fa-regular fa-paper-plane text-[10px]"></i> Send Notification
                        ...
                        <tr class="hover:bg-slate-50 transition-colors group">
                            <td class="py-3.5 px-3">
                                <div class="flex items-center gap-3">
                                    <div class="h-8 w-8 rounded-full bg-rose-50 text-rose-600 flex items-center justify-center font-bold text-[11px] border border-rose-100">EB</div>
                                    <div>
                                        <p class="font-semibold text-slate-800 group-hover:text-rose-600 transition">Ebenezer Boateng</p>
                                        <p class="text-[10px] text-slate-500">Senior Secondary • Cape Coast</p>
                                    </div>
                                </div>
                            </td>
                            <td class="py-3.5 px-3 font-mono text-slate-600">GNT-5512-2023</td>
                            <td class="py-3.5 px-3">
                                <span class="text-rose-700 font-medium bg-rose-50 border border-rose-200 px-2 py-0.5 rounded-md">Expired</span>
                            </td>
                            <td class="py-3.5 px-3 text-right">
                                <button type="button" onclick="triggerNotification(this)" class="cursor-pointer inline-flex items-center gap-1 bg-rose-50 hover:bg-rose-600 text-rose-700 hover:text-white border border-rose-200 font-medium px-3 py-1.5 rounded-lg text-[11px] active:scale-95 transition-all">
        ...
        <div class="dash-card rounded-2xl p-5 flex flex-col justify-between">
            ...
            <div class="space-y-3 flex-1 overflow-y-auto custom-scroll max-h-[220px] pr-1">
                <div class="flex justify-between items-center bg-slate-50 p-3 rounded-xl border border-slate-100 hover:border-slate-200 transition">
                    <div class="flex items-center space-x-3">
                        <span class="bg-emerald-50 text-emerald-700 border border-emerald-200 text-[9px] font-bold px-2 py-1 rounded-md uppercase tracking-wider">New</span>
                        <div>
                            <p class="text-xs font-semibold text-slate-800">Salifu Abdul Rahman</p>
                            <span class="text-[10px] text-slate-500">Core Setup & Activation</span>
                        </div>
                    </div>
                    <div class="text-right">
                        <span class="text-xs font-bold text-emerald-600">+₵150.00</span>
                ...
                <div class="flex justify-between items-center bg-slate-50 p-3 rounded-xl border border-slate-100 hover:border-slate-200 transition">
                    <div class="flex items-center space-x-3">
                        <span class="bg-indigo-50 text-indigo-700 border border-indigo-200 text-[9px] font-bold px-2 py-1 rounded-md uppercase tracking-wider">Renewal</span>
                        <div>
                            <p class="text-xs font-semibold text-slate-800">Comfort Mensah</p>
                            <span class="text-[10px] text-slate-500">Annual Sub Assessment</span>
                        </div>
                    </div>
                    <div class="text-right">
                        <span class="text-xs font-bold text-emerald-600">+₵360.00</span>
                ...
                <div class="flex justify-between items-center bg-slate-50 p-3 rounded-xl border border-slate-100 hover:border-slate-200 transition">
                    <div class="flex items-center space-x-3">
                        <span class="bg-indigo-50 text-indigo-700 border border-indigo-200 text-[9px] font-bold px-2 py-1 rounded-md uppercase tracking-wider">Renewal</span>
                        <div>
                            <p class="text-xs font-semibold text-slate-800">Patrick Gyamfi</p>
                            <span class="text-[10px] text-slate-500">Annual Sub Assessment</span>
                        </div>
                    </div>
                    <div class="text-right">
            ...
            <div class="mt-4 pt-3 border-t border-slate-100 text-center">
                <a href="#" class="text-[11px] font-semibold text-indigo-600 hover:text-indigo-700 transition-colors">
...
<script>
    ...
    function triggerNotification(buttonElement) {
        ...
        setTimeout(() => {
            ...
            buttonElement.classList.remove('bg-indigo-600', 'bg-rose-50', 'text-rose-700');
            ...
            setTimeout(() => {
                ...
                buttonElement.classList.remove('bg-emerald-50', 'text-emerald-700', 'border', 'border-emerald-200');
