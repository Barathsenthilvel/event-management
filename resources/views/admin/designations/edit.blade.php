    ...
    <div class="rounded-[24px] border border-white bg-linear-to-br from-white via-white to-indigo-50/40 shadow-sm p-6">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <p class="mt-1 text-xs font-bold text-slate-500">{{ $designation->name }}</p>
            </div>
    ...
    <div class="bg-white rounded-[24px] border border-slate-100 shadow-sm p-6 max-w-xl">
        <form method="POST" action="{{ route('admin.designations.update', $designation) }}" class="space-y-5">
            ...
            <div>
                ...
                <input id="name" name="name" value="{{ old('name', $designation->name) }}" required maxlength="255"
            ...
            <div>
                ...
                <input id="sort_order" name="sort_order" type="number" min="0" max="65535" value="{{ old('sort_order', $designation->sort_order) }}"
