...
<form method="POST" action="{{ $action }}" class="space-y-6" id="adminJobForm">
    @csrf
        ...
        <div class="space-y-4">
            <div>
                <div class="mb-2 flex items-center justify-between gap-2">
                    <label class="block text-xs font-black text-slate-600">Search Hospital @include('admin.partials.required-mark')</label>
                    <button
                        type="button"
                ...
                <div class="relative" id="hospitalSearchWrap">
                    <input type="hidden" name="hospital" id="hospitalValue" value="{{ $selectedHospital }}">
                    <input
                        type="text"
...
<div id="hospitalModal" class="fixed inset-0 z-[120] hidden items-center justify-center bg-slate-900/45 p-4">
    <div class="w-full max-w-lg rounded-2xl border border-slate-200 bg-white shadow-2xl">
        ...
        <form id="hospitalModalForm" class="space-y-4 px-5 py-4">
            <div>
                <label class="mb-1 block text-xs font-black text-slate-600">Hospital Name @include('admin.partials.required-mark')</label>
            ...
            <div>
                <label class="mb-1 block text-xs font-black text-slate-600">Address @include('admin.partials.required-mark')</label>
...
<script>
    (() => {
        ...
        const storeUrl = @json(route('admin.jobs.hospitals.store'));
